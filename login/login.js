...
/** @type {HTMLInputElement} */
var fine = document.getElementsByClassName("fine");
/** @type {HTMLInputElement} */
var social = document.getElementsByClassName("button_login");
/** @type {HTMLInputElement} */
...
window.onload = function () {
  ...
  function login_link() {
    ...
    for (let i in social) {
      if (social[i].onclick) {
        social[i].window.location.href =
          "https://www.epis.or.kr/api/sns/kakaoAPI";
      }
      if (social[i].onclick) {
      ...
      if (social[i].onclick) {
        social[i].window.location.href =
          "https://www.facebook.com/?stype=lo&jlou=Afdt_MIcW1S3cd3t4H9uB-t75_SUku-zqX_4OgfF0cEQYvo_ABClIA0moV0sXt_jZ246ijQdpZIHo0rPfJcusxxmK0Y-hlJL0QqIvHQfmCB-7w&smuh=51807&lh=Ac8mlx2vldB8W_rKeEs";
      }
    }
